...
const Card = props => {
  const { isButton, date, title, text, isDone, id, onCardEdit, setEditCard, tags , draggable, allTags} = props;
  ...
  return <div onDragStart={draggable ? onDragStart : null} draggable={draggable} data-card={true} id={id} onClick={onCardClick} className={`${css.card} ${isButton ? '' : css.card_canban} card`}>
      ...
      <TagCloud allTags={allTags} onCardEdit={onCardEdit} id={id} tags={tags}/>
